...
CREATE TABLE ITEM(
  ...
  CREATE TABLE Customer_Orders(
        ...
        FOREIGN KEY (ItemNumber) REFERENCES ITEM(ItemNumber)
			ON UPDATE CASCADE
            ON DELETE CASCADE,
        ItemQuantity INT(225)
        );      
        
INSERT INTO CUSTOMER (CustomerNumber, Firstname, Lastname, Street, City, State, ZIP, AREA, NUM, EMAIL)
...
INSERT INTO ITEM(ItemNumber, Description, Price, Weight, AnnualSales, StockLoc)
...
INSERT INTO Customer_Orders(OrderNumber, NoItems, OrderDate, ReqShipDate, ActShipDate, ShipCarrier, CustomerNumber , ItemNumber,ItemQuantity)
